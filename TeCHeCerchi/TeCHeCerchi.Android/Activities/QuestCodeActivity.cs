...
namespace TeCHeCerchi.Droid.Activities
{
    ...
    public class QuestCodeActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            if (!string.IsNullOrWhiteSpace(QuestActivity.ViewModel.Quest.Extra.Hint))
                labelHint.Text = QuestActivity.ViewModel.Quest.Extra.Hint;
        }

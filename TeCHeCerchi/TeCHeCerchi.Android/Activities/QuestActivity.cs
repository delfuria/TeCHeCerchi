...
namespace TeCHeCerchi.Droid.Activities
{
    [Activity(Label = "TeCHe Cerchi", ScreenOrientation = ScreenOrientation.Portrait, ParentActivity = typeof(WelcomeActivity))]
    public class QuestActivity : Activity, BeaconManager.IServiceReadyCallback
    {
        ...
        private void SetBeaconText(bool beaconsClose)
        {
            if (ViewModel.ExtraTaskVisible)
            {
                ...
                beaconNearby.SetTextColor(TeCHeCerchi.Shared.Helpers.Color.Blue.ToAndroidColor());
                return;
            }
            ...
            else
            {
                ...
                beaconNearby.SetTextColor(TeCHeCerchi.Shared.Helpers.Color.LightGray.ToAndroidColor());
            }
        }
        ...
        private void CheckBluetooth()
        {
            ...
            else if (!beaconManager.IsBluetoothEnabled)
            {
                ...
                ServiceContainer.Resolve<IMessageDialog>().SendMessage("Bluetooth Turned Off.",
                    "Please enable Bluetooth for Beacon support or you can enjoy TeCHe Cerchi by scanning QR codes.");
                beaconsEnabled = false;
            }
